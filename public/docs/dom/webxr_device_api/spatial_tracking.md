...
For example, given an [`XRSession`](../xrsession) whose reference space is `worldRefSpace`, the following line of code would request the first frame of animation to be scheduled:
