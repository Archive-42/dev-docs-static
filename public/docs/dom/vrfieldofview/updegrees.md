...
The `upDegrees` read-only property of the [`VRFieldOfView`](../vrfieldofview) interface returns the number of degrees upwards that the field of view extends in.
...
<table><thead><tr class="header"><th>Specification</th><th>Status</th><th>Comment</th></tr></thead><tbody><tr class="odd"><td><a href="https://immersive-web.github.io/webvr/spec/1.1/#dom-vrfieldofview-updegrees">WebVR 1.1<br />
<span class="small">The definition of 'upDegrees' in that specification.</span></a></td><td><span class="spec-draft">Draft</span></td><td>Initial definition</td></tr></tbody></table>
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/VRFieldOfView/upDegrees" class="_attribution-link">https://developer.mozilla.org/en-US/docs/Web/API/VRFieldOfView/upDegrees</a>
