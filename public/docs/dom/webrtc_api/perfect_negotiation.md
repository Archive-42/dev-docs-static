...
All other descriptions received from the impolite peer are processed as normal, by passing them into [`setRemoteDescription()`](../rtcpeerconnection/setremotedescription).
