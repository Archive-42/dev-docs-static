...
The `lastEventID` read-only property of the [`ServiceWorkerMessageEvent`](../serviceworkermessageevent) interface represents, in [server-sent events](../en-us/docs/server-sent_events/using_server-sent_events), the last event ID of the event source.
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerMessageEvent/lastEventId" class="_attribution-link">https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerMessageEvent/lastEventId</a>
