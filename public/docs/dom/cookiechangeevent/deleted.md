...
The `deleted` read-only property of the [`CookieChangeEvent`](../cookiechangeevent) interface returns an array of the cookies that have been deleted by the given `CookieChangeEvent` instance.
...
<table><thead><tr class="header"><th>Specification</th><th>Status</th><th>Comment</th></tr></thead><tbody><tr class="odd"><td><a href="https://wicg.github.io/cookie-store/#dom-cookiechangeevent-deleted">Cookie Store API<br />
<span class="small">The definition of 'CookieStoreManager.deleted' in that specification.</span></a></td><td><span class="spec-draft">Draft</span></td><td>Initial definition.</td></tr></tbody></table>
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/CookieChangeEvent/deleted" class="_attribution-link">https://developer.mozilla.org/en-US/docs/Web/API/CookieChangeEvent/deleted</a>
