...
An integer value indicating the distance in pixels from the left edge of the element's nearest root element and the left edge of the [`<img>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img) element's border box. The nearest root element is the outermost [`<html>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/html) element that contains the image. If the image is in an [`<iframe>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe), its `x` is relative to that frame.
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/x" class="_attribution-link">https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/x</a>
