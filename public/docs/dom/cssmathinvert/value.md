...
The CSSMathInvert.value read-only property of the [`CSSMathInvert`](../cssmathinvert) interface returns a [`CSSNumericValue`](../cssnumericvalue) object.
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/CSSMathInvert/value" class="_attribution-link">https://developer.mozilla.org/en-US/docs/Web/API/CSSMathInvert/value</a>
